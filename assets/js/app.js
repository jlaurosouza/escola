...
$(document).ready(function() {
	...
	$('#refresh').click(function(e) {
		$.SmartMessageBox({
			title : "<i class='fa fa-refresh' style='color:green'></i> Recarregar a página atual?",
			content : "Seus dados não salvos serão perdidos...",
			buttons : '[Não][Sim]'
	...
	$('#logout a').click(function(e) {
		...
		$.SmartMessageBox({
			...
			content : $.logoutMSG || "Você pode melhorar sua segurança fechando este navegador após sair do sistema",
			buttons : '[Não][Sim]'

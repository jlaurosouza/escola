...
<section id="widget-grid" class="">
    <section id="widget-grid" style=" size: auto ;">
        <div class="row" >
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="min-height: 450px !important;">
                <div class="text-center error-box">
                    <br />
                    <br /> 
                    <br />
                    <h2 class="font-xl"><strong><i class="fa fa-fw fa-thumbs-up fa-lg txt-color-orange"></i><label style="color: #a8a8a8!important;"> Seja Bem vindo! </label> </strong></h2>                        

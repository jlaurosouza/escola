...
class Cursos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('descricao, valor, idoperador, datahoracriacao, datahoraalteracao', 'required'),
			...
			array('id, descricao, valor, idoperador, datahoracriacao, datahoraalteracao, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'alunoscursoses' => array(self::HAS_MANY, 'Alunoscursos', 'idcurso'),
		);
	}
